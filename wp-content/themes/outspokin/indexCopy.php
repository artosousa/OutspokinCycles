...
<section id="services" class="clearfix">
	...
	<div class="services-wrap">
		...
		<div class="button"><a href="#contact">get in touch</a></div>
	</div>
</section>
		...
		<ul class="events-wrap-list" class="clearfix">
			<li class="events-wrap-list-item sticky-date">
					<div class="events-wrap-list-item-container clearfix">
						<div class="date-header" style="background: url(http://www.arthursousa.com/DEV/Outspokin/wp-content/files_mf/143592474011024785_888425051225475_7393348121533599578_o.jpg) center top no-repeat; background-size:cover;">
							<div class="date-wrap">Wed<div class="date-month"></div>
							</div>
						</div>
			...
			<?php 
				$args = array( 'post_type' => 'event', 'posts_per_page' => 100, 'orderby' => 'ID', 'order' => 'asc' );
			...
			?>
				<li class="events-wrap-list-item generated event-<?php the_ID(); ?>">
					<div class="events-wrap-list-item-container clearfix">
						<div class="date-header" style="background: url(<?php echo get('event_image');?>) center top no-repeat; background-size:cover;">
							<div class="date-wrap">
								<?php echo get('date'); ?>
