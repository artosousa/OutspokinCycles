				...
				<div id="example" class="mightyslider_modern_skin">
				    ...
				    <div class="frame">
				        ...
				        <div class="slide_element">
							...
							?>
				            <div class="slide" style="background: url(<?php echo get('header_image'); ?> ) center center !important; background-size:cover !important;">
				            	<div class="showcase-content-wrapper-container-copy">
										
										<div class="main-header-times-wrap clearfix">
											<img src="<?php bloginfo('template_url');?>/images/outspokinHero.png" title="Outspokin Cycles - London, Ontario" alt="Outspokin Cycles" />
											<ul class="main-header-times clearfix">
											...
											<div class="main-header-social-wrap clearfix">
